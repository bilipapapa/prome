...
export function useTable(options?: eleHookProps) {
	const initOptions: eleHookProps = {
		...
		// 表格展示的数据数组，默认为空数组
		dataList: [],
		// 分页组件属性配置，如当前页码、每页展示数据条数等，默认值为 {pageNum:1, pageSize:10,total:0,pageSizes:[1, 10, 20, 50, 100, 200],layout:'total, sizes, prev, pager, next, jumper'}
		pagination: {
			pageNum: 1,
			pageSize: 10,
			total: 0,
